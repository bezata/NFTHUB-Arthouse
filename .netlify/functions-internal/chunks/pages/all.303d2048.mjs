...
/* empty css                           */import { w3mProvider, w3mConnectors, EthereumClient } from '@web3modal/ethereum';
import { usePrepareContractWrite, useContractWrite, useWaitForTransaction, configureChains, createClient, useAccount, WagmiConfig, usePrepareSendTransaction, useSendTransaction } from 'wagmi';
...
/* empty css                         *//* empty css                           */import { Web3Modal, Web3Button } from '@web3modal/react';
		...
		outputs: [
			{
				components: [
					...
					},
					{
						...
						internalType: "struct NFTH.NFTMetadata",
						name: "metadata",
						type: "tuple"
					},
					{
...
function MintNFT() {
  const {
    ...
    address: "0xFfaf3802891a8667df7639d8eBCc1fe6DE023A6f",
    abi: NFTH_ABI,
    functionName: "mintNFT",
    args: ["NFTH", "NH", "https://gateway.ipfs.io/ipfs/QmSPp23WYfkSKprn48DLbPpvkh4Ce3u9VJqasGvMg9pFV3"]
  });
  const {
    data,
    write
  ...
  return /* @__PURE__ */ jsxs("div", {
    children: [/* @__PURE__ */ jsx("button", {
      ...
      children: ["Successfully minted your NFT!", /* @__PURE__ */ jsx("div", {
...
__astro_tag_component__(MintNFT, "@astrojs/react");
...
function MintNFTForm() {
  ...
  React.useMemo(() => {
    if (!debouncedTokenId)
      return null;
    const parsedValue = parseInt(debouncedTokenId);
    if (isNaN(parsedValue))
      return null;
    return BigNumber.from(parsedValue);
  }, [debouncedTokenId]);
  const {
    config,
    error: prepareError,
  ...
  return /* @__PURE__ */ jsxs("form", {
    ...
    children: [/* @__PURE__ */ jsx("label", {
      ...
      placeholder: "https://gateway.ipfs.io/ipfs/QmSPp23WYfkSKprn48DLbPpvkh4Ce3u9VJqasGvMg9pFV3",
      value: uri
    }), /* @__PURE__ */ jsx("button", {
      disabled: !write || isLoading,
      children: isLoading ? "Minting..." : "Mint"
    ...
    }), (isPrepareError || isError) && /* @__PURE__ */ jsxs("div", {
      children: ["Error: ", (prepareError || error)?.message]
    })]
  });
}
__astro_tag_component__(MintNFTForm, "@astrojs/react");
...
function SendTransactions() {
  return /* @__PURE__ */ jsxs(WagmiConfig, {
    client: wagmiClient,
    children: [/* @__PURE__ */ jsx(SendTransaction, {}), /* @__PURE__ */ jsx(MintNFT, {}), /* @__PURE__ */ jsx(MintNFTForm, {})]
  });
}
__astro_tag_component__(SendTransactions, "@astrojs/react");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Dashboard" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section>
    ...
    ${renderComponent($$result2, "SendTransactions", SendTransactions, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/minec/OneDrive/Masa\xFCst\xFC/Dosyalar/dacadecelonft/src/components/TryMint", "client:component-export": "default" })}
