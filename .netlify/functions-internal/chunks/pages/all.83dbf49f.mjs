...
/* empty css                          */import Dropzone from 'react-dropzone-uploader';
...
const MyUploader = () => {
  ...
  const handleSubmit = (files, allFiles) => {
    ...
    async function main() {
      ...
      function log(msg) {
        document.getElementById("out").innerHTML += `${JSON.stringify(data[0].xhr.responseText, 2)}
`;
      }
    }
    main();
...
__astro_tag_component__(MyUploader, "@astrojs/react");

const NFTHUB_ADDRESS = "0xdd0C71C96B418978a74B1e60945733f01A047C77";
function NFTHUBComponent() {
  ...
  const {
    ...
    args: [name, ethers.utils.parseUnits(newPrice.toString(), "ether"), description, tokenURI],
    value: listingPrice,
    overrides: {
  ...
  return /* @__PURE__ */ jsxs("div", {
    children: [/* @__PURE__ */ jsx("h2", {
      ...
      }), /* @__PURE__ */ jsx(MyUploader, {}), /* @__PURE__ */ jsx("button", {
