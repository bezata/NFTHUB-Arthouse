...
function ModalWallet() {
  ...
  return /* @__PURE__ */ jsxs(WagmiConfig, {
    ...
    }), /* @__PURE__ */ jsx(MintNFT, {}), /* @__PURE__ */ jsx(Web3Button, {})]
  });
}
...
function MintNFTForm() {
  ...
  const tokenIdValue = React.useMemo(() => {
    if (!debouncedTokenId)
      return null;
...
__astro_tag_component__(MintNFTForms, "@astrojs/react");
...
function SendTransactions() {
  return /* @__PURE__ */ jsxs(WagmiConfig, {
    client: wagmiClient,
    children: [/* @__PURE__ */ jsx(SendTransaction, {}), /* @__PURE__ */ jsx(MintNFTForms, {})]
  });
}
