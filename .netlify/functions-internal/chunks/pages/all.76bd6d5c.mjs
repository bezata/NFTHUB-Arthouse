...
import { configureChains as configureChains$1, createClient as createClient$1, useAccount, WagmiConfig, usePrepareSendTransaction, useSendTransaction, useWaitForTransaction, mainnet as mainnet$1 } from 'wagmi';
import { celoAlfajores } from 'wagmi/chains';
import { jsxs, jsx } from 'react/jsx-runtime';
import React from 'react';
import { useDebounce } from 'use-debounce';
import { publicProvider as publicProvider$1 } from 'wagmi/providers/public';
  ...
  <body class="astro-QUP72GQN">
    ...
    <div class="admin-interface astro-QUP72GQN">
      ${renderComponent($$result, "Navigation", $$Navigation, { "class": "astro-QUP72GQN" }, { "default": ($$result2) => renderTemplate`<li class="menu-item astro-QUP72GQN">
          ...
          <a href="/media/" class="astro-QUP72GQN">
            ${renderComponent($$result2, "Icon", $$Icon, { "pack": "majesticons", "name": "plus-line", "class": "astro-QUP72GQN" })}
...
const {
  provider
} = configureChains$1(chains, [w3mProvider({
  projectId
})]);
const wagmiClient = createClient$1({
  autoConnect: true,
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Dashboard" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section>
    ...
    ${renderComponent($$result2, "ModalWallet", ModalWallet, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/minec/OneDrive/Masa\xFCst\xFC/Dosyalar/dacadecelonft/src/components/Web3Modal", "client:component-export": "default" })}
    <p class="size-20"></p>
...
const $$file$7 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/index.astro";
const $$url$7 = "";
...
const $$Messages = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Messages" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section>
    ...
    <div class="space-content">
      ...
      ${renderComponent($$result2, "Modal", $$Modal, { "triggerId": "modal-trigger", "title": "Add message", "closeText": "Cancel" }, { "default": ($$result3) => renderTemplate`<p>You can use this component to include a form that adds a new message to the list.</p>` })}
    </div>
  </section>` })}`;
}, "C:/Users/minec/OneDrive/Masa\xFCst\xFC/Dosyalar/dacadecelonft/src/pages/messages.astro");

const $$file$6 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/messages.astro";
const $$url$6 = "/messages";
...
const $$file$5 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/products.astro";
const $$url$5 = "/products";
...
const $$file$4 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/settings.astro";
const $$url$4 = "/settings";
...
const $$file$3 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/wishlist.astro";
const $$url$3 = "/wishlist";
      ...
      <div class="login__inner reveal h-screen astro-SGPQYURT">
        ...
        <div class="inner__form space-content astro-SGPQYURT">
          ${renderComponent($$result2, "Notification", $$Notification, { "class": "astro-SGPQYURT" }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Icon", $$Icon, { "pack": "majesticons", "name": "information-circle-line", "class": "astro-SGPQYURT" })}<p class="size-14 astro-SGPQYURT">
            ...
            </p>${renderComponent($$result3, "ModalWallet", ModalWallet, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/minec/OneDrive/Masa\xFCst\xFC/Dosyalar/dacadecelonft/src/components/Web3Modal", "client:component-export": "default", "class": "astro-SGPQYURT" })}` })}
...
const $$file$2 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/login.astro";
const $$url$2 = "/login";
...
const $$Media = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Media;
  const { chains, provider, webSocketProvider } = configureChains$1(
    [mainnet$1],
    [publicProvider$1()]
  );
  const WagmiClient = createClient$1({
  ...
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Media" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section>
    ...
    <div class="space-content">
      ...
      ${renderComponent($$result2, "Modal", $$Modal, { "triggerId": "modal-trigger", "title": "Add media", "closeText": "Cancel" }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "WagmiConfig", WagmiConfig, { "client": WagmiClient, "client:load": true, "client:component-hydration": "load", "client:component-path": "wagmi", "client:component-export": "WagmiConfig" }, { "default": ($$result4) => renderTemplate`${renderComponent($$result4, "SendTransaction", SendTransaction, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/minec/OneDrive/Masa\xFCst\xFC/Dosyalar/dacadecelonft/src/components/ContractWrite", "client:component-export": "SendTransaction" })}` })}<p>
...
const $$file$1 = "C:/Users/minec/OneDrive/Masaüstü/Dosyalar/dacadecelonft/src/pages/media.astro";
const $$url$1 = "/media";
