...
import { configureChains, createClient, useAccount, WagmiConfig, usePrepareSendTransaction, useSendTransaction, useWaitForTransaction } from 'wagmi';
...
function SendTransactions() {
  return /* @__PURE__ */ jsx(WagmiConfig, {
    client: wagmiClient,
    children: /* @__PURE__ */ jsx(SendTransaction, {})
  });
}
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultLayout", $$DefaultLayout, { "title": "Dashboard" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead($$result2)}<section>
    ...
    ${renderComponent($$result2, "SendTransactions", SendTransactions, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/minec/OneDrive/Masa\xFCst\xFC/Dosyalar/dacadecelonft/src/web3stuff/TryMint", "client:component-export": "default" })}
