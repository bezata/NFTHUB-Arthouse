...
import { configureChains, createClient, useAccount, WagmiConfig, usePrepareSendTransaction, useSendTransaction, useWaitForTransaction, mainnet as mainnet$1 } from 'wagmi';
import { celoAlfajores, mainnet, optimism } from 'wagmi/chains';
...
function SendTransaction() {
  ...
  const {
    chains,
    provider
  } = configureChains([mainnet, optimism], [alchemyProvider({
    apiKey: "H8sAFl88aF5Iu5jiPlGwPw9T3QrHlNED"
  }), publicProvider()]);
